...
//              the C18 client API — load program + config overlay (they
//              are just reg-bus writes, SPEC-7-10/14..26), tick with pin
//              in, state out.
//
...
// ---------------------------------------------------------------------------
// Game-facing snapshot (little-endian; offsets noted for the JS reader).
// ---------------------------------------------------------------------------
struct PioSnapshot {
